...
class AuthShared {
  ...
  static TextStyle textTitle0   = TextStyle(fontSize: fontSize1 * 6, color: color1.withOpacity(0.6));
  ...
  static TextStyle textLinkBig  = TextStyle(fontSize: fontSize1 * 1.5, color: color1, fontWeight: FontWeight.bold);
